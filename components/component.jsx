...
* @see https://v0.dev/t/l37T9czal8R
    ...
    (<div className="min-h-screen bg-black text-white grid grid-cols-[300px_1fr]">
      <div className="border-r border-gray-800 p-4 space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="p-4 border border-gray-700 rounded-lg glow">
            <h3 className="text-xl font-semibold text-white">Token 3</h3>
            <p className="text-muted-foreground text-white">Description of Token 3</p>
          </div>
          <div className="p-4 border border-gray-700 rounded-lg glow">
            <h3 className="text-xl font-semibold text-white">Token 4</h3>
            <p className="text-muted-foreground text-white">Description of Token 4</p>
          </div>
        </div>
      </div>
      <div>
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div
                    className="border border-gray-700 p-4 flex items-center justify-center glow">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="amount"
                  placeholder="Optional, defaults to 0 if not filled"
                  className="glow" />
              </div>
